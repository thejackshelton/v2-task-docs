...
Sometimes you might want tasks to run at the same time. You can do this by not awaiting the promise:
...
<details class="mt-6 bg-neutral-900 p-[1ch] rounded-md">
  ...
  The scheduler uses a [priority queue](https://encore.dev/blog/queueing) to determines when this work should happen. 
</details>

...
When a user visits a page that uses [SSR/SSG](https://www.youtube.com/watch?v=0bvo6UKkNDA), the server prepares everything - including running your tasks - before sending the HTML to the browser:
...
This is different from traditional client-side frameworks where all code runs in the browser. With Qwik's SSR, your tasks run on the server first, making your site faster to load and more SEO-friendly.
